<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeFile="PesquisarFornecedores.aspx.cs" Inherits="Fornecedores_PesquisarFornecedores" %>
<%@ Register src="../MBOX/MBOX.ascx" tagname="MBOX" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Barra" Runat="Server">
    <p>
        pesquisa de fornecedor</p>
</asp:Content>
 ...
 <div id="filtros">
            ...
            <tr>
                ...
                <td rowspan="4" width="10%" valign="bottom">
                    <asp:Button ID="btnPesquisar" runat="server" CssClass="Button" OnClick="btnPesquisar_Click"
                        Text="Pesquisar" onmouseout="tooltip.hide();" onmouseover="tooltip.show('Pesquisa os fornecedores cadastradas, de acordo com o(s) filtro(s) escolhido(s)')" />
                </td>
            </tr>
            <tr>
    ...
    <div class="contador_itens_grid">
            ...
            <asp:DropDownList ID="ddlQuantidaItensGrid" runat="server" CssClass="DropDownList" Width="100%" AutoPostBack="True" 
              onselectedindexchanged="ddlQuantidaItensGrid_SelectedIndexChanged" onmouseout="tooltip.hide();" onmouseover="tooltip.show('Quantidade de fornecedores que serão exibidos em cada página do resultado da pesquisa')">
        ...
        <div>
            <asp:UpdatePanel ID="UPFornecedores" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:DataGrid ID="dgrFornecedores" runat="server" AllowPaging="True" 
                        ...
                        ondeletecommand="dgrFornecedores_DeleteCommand" 
                        OnEditCommand="dgrFornecedores_EditCommand" 
                        OnItemDataBound="dgrFornecedores_ItemDataBound" 
                        OnPageIndexChanged="dgrFornecedores_PageIndexChanged" PageSize="8" 
                        Width="100%">
                            ...
                            <asp:TemplateColumn HeaderText="Edit.">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgAbrir0" runat="server" AlternateText="." 
                                        ...
                                        onmouseover="tooltip.show('Abre o fornecedor para edição dos dados')" Visible="<%#BindingVisivel(Container.DataItem) %>" Enabled="<%#BindingVisivel(Container.DataItem) %>"/>
                                </ItemTemplate>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <HeaderTemplate>
                                    <asp:ImageButton ID="ibtnExcluir1" runat="server" CommandName="Delete" 
                                        ...
                                        onmouseover="tooltip.show('Exclui o(s) fornecedor(es) selecionada(s)')" 
