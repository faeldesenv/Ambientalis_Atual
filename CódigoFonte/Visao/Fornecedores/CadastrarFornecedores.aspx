<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeFile="CadastrarFornecedores.aspx.cs" Inherits="Fornecedores_CadastrarFornecedores" %>
 ...
 <div style="width: 100%; height: auto;">
                        <table cellpadding="0" cellspacing="5" width="100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbxNome" runat="server" CssClass="TextBox" 
                                        ValidationGroup="rfvSalvar" Width="305px"></asp:TextBox>&nbsp;
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                        ControlToValidate="tbxNome" ErrorMessage="Campo Obrigatório" 
                            ...
                            <tr>
                                <td align="right" width="40%">
                                    &nbsp;</td>
                                <td>
                    <asp:CheckBox ID="chkAtivo" runat="server" Text="Ativo" Checked="True" onmouseout="tooltip.hide();" onmouseover="tooltip.show('Somente poderão ser acessados, editados e excluídos, dados de fornecedores ativos')"/>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" width="40%">
