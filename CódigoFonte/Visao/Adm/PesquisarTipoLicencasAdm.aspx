<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Adm.master" AutoEventWireup="true"
    CodeFile="PesquisarTipoLicencasAdm.aspx.cs" Inherits="Licenca_PesquisarTipoLicencasAdm" %>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <HeaderTemplate>
                                    <asp:ImageButton ID="ibtnExcluir" runat="server" CommandName="Delete" ImageUrl="~/imagens/excluir.gif"
                                        onmouseout="tooltip.hide();" onmouseover="tooltip.show('Exclui os tipos de licença selecionados')" />
