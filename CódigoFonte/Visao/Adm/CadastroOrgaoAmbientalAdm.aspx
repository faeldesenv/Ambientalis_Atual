<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Adm.master" AutoEventWireup="true" CodeFile="CadastroOrgaoAmbientalAdm.aspx.cs" Inherits="OrgaoAmbiental_CadastroOrgaoAmbientalAdm" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="ddlTipoOrgao" ErrorMessage="Campo Obrigatório" 
                            InitialValue="0" ValidationGroup="rfvSalvar"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSalvar" runat="server" CssClass="Button" Text="Salvar" 
                            onclick="btnSalvar_Click" ValidationGroup="rfvSalvar" onmouseout="tooltip.hide();" onmouseover="tooltip.show('Salva as alterações em um orgão ambiental existente ou cria um novo orgão ambiental')" />
                        <asp:Button ID="btnNovo" runat="server" CssClass="Button" Text="Novo" 
                            onmouseout="tooltip.hide();" 
                            onmouseover="tooltip.show('Abre os campos para cadastro de um novo orgão ambiental')" 
                            onclick="btnNovo_Click" />
                        
                        <asp:Button ID="btnExcluir" runat="server" CssClass="ButtonExcluir" 
                            onclick="Button1_Click" Text="Excluir" onmouseout="tooltip.hide();" onmouseover="tooltip.show('Exclui o orgão ambiental carregado')" />
