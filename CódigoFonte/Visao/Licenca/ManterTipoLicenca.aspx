<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeFile="ManterTipoLicenca.aspx.cs" Inherits="Licenca_ManterTipoLicenca" %>
    ...
    <script src="../Scripts/mask.js" type="text/javascript"></script>    
     <script type="text/javascript">
         ...
         function LimparCampos() {
             $('#<%= tbxValidadePadraoCondicionante.ClientID %>').val("");
             $('#<%= tbxDescricao.ClientID %>').val("");
             $('#<%= hfIdCondicionante.ClientID %>').val("");
         }
    ...
    <div>
        <table cellpadding="0" cellspacing="5" width="100%">
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvNomeLincenca" runat="server" 
                        ControlToValidate="tbxNome" ErrorMessage="Campo Obrigatório!!"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td align="right">
        ...
        <div>
            <strong>Condicionantes Padrões:
                    ...
                    runat="server" OnPreRender="ibtnAdicionarCondicionante_PreRender" OnClientClick="javascript:LimparCampos();" 
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSalvar" runat="server" CssClass="Button" Text="Salvar" 
                            OnClick="btnSalvar_Click" onprerender="PermissaoUsuario_PreRender" onmouseout="tooltip.hide();" onmouseover="tooltip.show('Salva as alterações em um tipo de licença existente ou cria um novo tipo de licença')"/>
                        <asp:Button ID="btnNovo" runat="server" CssClass="Button" Text="Novo" 
                            OnClick="btnNovo_Click" onprerender="PermissaoUsuario_PreRender" onmouseout="tooltip.hide();" onmouseover="tooltip.show('Abre os campos para cadastro de um novo tipo de licença')" />
                        <asp:Button ID="btnExcluir" runat="server" CssClass="ButtonExcluir" Text="Excluir"
                            OnClick="btnExcluir_Click" OnPreRender="PermissaoUsuario_PreRender" onmouseout="tooltip.hide();" onmouseover="tooltip.show('Exclui o tipo de licença selecionado')"/>
                    </td>
                </tr>
            </table>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="tbxDescricao" runat="server" CssClass="TextBox" Width="90%" Height="60px"
                                            TextMode="MultiLine" MaxLength="4000"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
