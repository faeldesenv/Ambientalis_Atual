    ...
    <div id="container">
        ...
        <div id="box_login">
            <p>
                <label class="req">
                    Usuário:
                <asp:TextBox ID="tbxUsuario" runat="server" CssClass="tbxAcesso"
                    ValidationGroup="rfv"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbxUsuario"
