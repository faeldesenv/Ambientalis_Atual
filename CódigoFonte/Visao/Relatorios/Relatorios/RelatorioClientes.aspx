<%@ Page Title="" Language="C#" MasterPageFile="~/Relatorios/MasterPage/MasterPageRelatorios.master" AutoEventWireup="true" CodeFile="RelatorioClientes.aspx.cs" Inherits="Relatorios_Relatorios_RelatorioClientes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphFiltros" Runat="Server">
    ...
    <table style="width: 100%; margin-right: 0px;">
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="tbxNomeRazaoCliente" runat="server" CssClass="TextBox" Width="50%">
                </asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="tbxCnpjCpfCliente" runat="server" CssClass="TextBox" Width="50%">
                </asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="ddlEstadoCliente" runat="server" CssClass="DropDownList" Width="50%" AutoPostBack="True" onselectedindexchanged="ddlEstadoCliente_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td align="left">
                <asp:UpdatePanel ID="UPCidadeCliente" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlEstadoCliente" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
