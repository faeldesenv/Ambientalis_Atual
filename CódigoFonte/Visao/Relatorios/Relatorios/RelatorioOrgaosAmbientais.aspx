<%@ Page Title="" Language="C#" MasterPageFile="~/Relatorios/MasterPage/MasterPageRelatorios.master" AutoEventWireup="true" CodeFile="RelatorioOrgaosAmbientais.aspx.cs" Inherits="Relatorios_Relatorios_RelatorioOrgaosAmbientais" %>
    ...
    <table width="100%">
        <tr>
            <td style="text-align:center;">
                Esse Relatório é carregado sem filtros
            </td>
        </tr>
    </table>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="grvRelatorio" CssClass="tabela_relatorio" runat="server" Font-Names="Arial" Width="100%" AutoGenerateColumns="False" EnableModelValidation="True" EnableTheming="False" EnableViewState="False" Font-Size="9pt">
        <Columns>
            ...
            <asp:BoundField DataField="GetCidadeEstado" HeaderText="Cidade/Estado"/>            
        </Columns>
