<%@ Page Title="" Language="C#" MasterPageFile="~/Relatorios/MasterPage/MasterPageRelatorios.master" AutoEventWireup="true" CodeFile="RelatorioGuiasDeUtilizacao.aspx.cs" Inherits="Relatorios_Relatorios_RelatorioGuiasDeUtilizacao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            adicionarDatePicker($("#<%= tbxDataVencimentoDeGuiaUtilizacao.ClientID %>"));
            adicionarDatePicker($("#<%= tbxDataVencimentoAteGuiaUtilizacao.ClientID %>"));
        });
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphFiltros" Runat="Server">
    ...
    <table width="100%">
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="ddlGrupoEconomicoGuiaUtilizacao" runat="server" AutoPostBack="True" CssClass="DropDownList" OnSelectedIndexChanged="ddlGrupoEconomicoGuiaUtilizacao_SelectedIndexChanged" Width="50%">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td align="left">
                <asp:UpdatePanel ID="upGuiaUtilizacao" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlEmpresaGuiaUtilizacao" runat="server" CssClass="DropDownList" Width="50%">
                        </asp:DropDownList>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlGrupoEconomicoGuiaUtilizacao" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="tbxDataVencimentoDeGuiaUtilizacao" runat="server" CssClass="TextBox" Width="22%"></asp:TextBox>
                &nbsp;até
                <asp:TextBox ID="tbxDataVencimentoAteGuiaUtilizacao" runat="server" CssClass="TextBox" Width="22%"></asp:TextBox>
            </td>
        </tr>
        <tr>
