...
public partial class Comercial_ContratoPersonalizado : PageBase
{
    ...
    protected void btnEnviarContrato_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            <td colspan='2' align='center' height='40px' valign='middle'><a target='_blank' href='http://sustentar.inf.br/site/website/Site/Cadastro.aspx" + dadosContrato + @"'>Conclua aqui o seu cadastro.</a></td></tr></tbody></table><div style='width:100%; height:20px;'></div></div>";
                    ...
                    {
                        msg.CriarMensagem("Erro ao enviar e-mail.: " + email.Erro, "Erro", MsgIcons.Erro);
                    }
                }
                else
                {
