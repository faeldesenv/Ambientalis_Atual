...
public partial class Relatorios_ControlHeader : System.Web.UI.UserControl
{
    ...
    public void ConfigurarCabecalho(string nomeRelatorio)
    {
        ...
        lblUsuario.Text = WebUtil.UsuarioComercialLogado.Login;
        lblFazenda.Text = "Sistema Sustentar Comercial - Relatório de " + nomeRelatorio;
        this.Page.Title = "Relatório - Sistema Sustentar Comercial: - Usuário: " + WebUtil.UsuarioComercialLogado.Login;
