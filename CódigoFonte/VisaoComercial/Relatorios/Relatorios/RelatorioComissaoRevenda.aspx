<%@ Page Title="" Language="C#" MasterPageFile="~/Relatorios/MasterPage/MasterPageRelatorioComercial.master" AutoEventWireup="true" CodeFile="RelatorioComissaoRevenda.aspx.cs" Inherits="Relatorios_Relatorios_RelatorioComissaoRevenda" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="grvRelatorio" CssClass="tabela_relatorio" runat="server" Font-Names="Arial" Width="100%" AutoGenerateColumns="False" EnableModelValidation="True" EnableTheming="False" EnableViewState="False" Font-Size="9pt">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Total da Revenda">
                <ItemTemplate>
                    <%# BindTotalComissaoRevenda(Container.DataItem)%>
                </ItemTemplate>
            </asp:TemplateField>                             
        </Columns>
